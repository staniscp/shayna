                ...
                <div class="product-thumbs">
                  ...
                  >
                    <div
                      ...
                      :class="thumbs[0] == main_product_photo ? 'active' : ''"
                    >
                    ...
                    <div
                      ...
                      :class="thumbs[1] == main_product_photo ? 'active' : ''"
                    >
                    ...
                    <div
                      ...
                      :class="thumbs[2] == main_product_photo ? 'active' : ''"
                    >
                    ...
                    <div
                      ...
                      :class="thumbs[3] == main_product_photo ? 'active' : ''"
                    >
...
export default {
  ...
  data() {
    return {
      main_product_photo: "img/mickey1.jpg",
      thumbs: [
        "img/mickey1.jpg",
        "img/mickey2.jpg",
        "img/mickey3.jpg",
  ...
  methods: {
    changeImage(urlImage) {
      this.main_product_photo = urlImage;
    },
  },
};
</script>
